                    ...
                    <div className="mt-8">
                        <div className="mt-6">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#2f5c96] hover:bg-[#1e40af] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                            ...
                            <div className="mt-8 text-center text-sm text-gray-600">
                                {isRegister ? (
                                    <>Já tem uma conta? <button onClick={toggleMode} className="font-medium text-[#2f5c96] hover:underline">Faça login</button></>
                                ) : (
                                    <>Não tem uma conta? <button onClick={toggleMode} className="font-medium text-[#2f5c96] hover:underline">Cadastre-se</button></>
                                )}
                            </div>
                        </div>
                    </div>
